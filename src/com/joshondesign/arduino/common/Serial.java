...
public class Serial implements SerialPortEventListener {
    ...
    public static boolean touchPort(String iname, int irate) throws SerialException {
        ...
        try {
            ...
            throw new SerialException("Serial port ''{0}'' already in use. Try quitting any programs that may be using it." + iname,e);
        } catch (Exception e) {
            throw new SerialException("Error touching serial port ''{0}''." + iname,e);
        }
        return result;
    }
