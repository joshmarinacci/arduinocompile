...
public abstract class Uploader implements MessageConsumer  {
    ...
    protected void flushSerialBuffer() throws RunnerException, SerialException, SerialNotFoundException {
    ...
    public void message(String s) {
        ...
        if(notFoundError) {
            ...
            exception = new RunnerException("the selected serial port {0} does not exist or your board is not connected");
            return;
        }
    ...
    void setUploadPortPath(String uploadPortPath) {
        this.uploadPortPath = uploadPortPath;
    }
